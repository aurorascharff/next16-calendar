    ...
    <div className="grid min-h-8" style={{ gridTemplateColumns: gridTemplate }}>
      ...
      {days.map(day => {
        ...
        return (
          <div
            className={cn(
              'border-divider dark:border-divider-dark flex min-w-0 flex-col gap-0.5 border-r p-1 transition-[background-color] duration-200 ease-out motion-reduce:transition-none',
