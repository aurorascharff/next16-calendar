...
export function EventChip({
  ...
  return (
    <button
      className={cn(
        'cal-chip group pointer-events-auto absolute flex touch-none flex-col overflow-hidden rounded-[5px] px-2 py-1 text-left ring-1 ring-inset transition-shadow focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent',
