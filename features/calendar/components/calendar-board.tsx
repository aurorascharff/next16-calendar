        ...
        >
          ...
          {dayKeys.map((day, index) => {
            ...
            return (
              <div
                className={cn(
                  'border-divider dark:border-divider-dark h-12 border-r px-0.5 py-1.5 transition-[background-color] duration-200 ease-out motion-reduce:transition-none sm:h-10 sm:px-3',
